...
<html class="loading">
  ...
  <div class="content-body">
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					...
					<textarea rows="12" class="form-control text-center form-checker mb-2" placeholder="PUT YOUR CAR HERE "></textarea>
					<textarea rows="1" class="form-control text-center" style="width: 70%; float: left ;"  id="sec" placeholder="sk live key"></textarea>
    ...
    <option </option>
                ...
                <option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/eur1CVV.php">CVV CHARGE: €1</option>
                
                
               <option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/eur1CCN.php">CCN CHARGE: €1</option> 
...
<footer>
  <p> <b><div class=text-danger> Thanks BY <a href="https://t.me/thuehttetaung">Dancing with your ghost 🇲🇲</b></a></div></p>
</footer>
<style>
